                ...
                'attributes' => [
                    'items' => [
                        0 => [
                            ...
                            'desc' => 'Begin your journey with a brand new &raquo;free&laquo; Gantry 5 template from Tiger12.',
...
<div>Find out more about using the Layout Manager in our <a href="http://docs.gantry.org/gantry5/configure/layout-manager">documentation</a>.</div>',
    ...
    <blockquote>
        ...
        <p class="h3">"Helium is a beautiful, free theme made by the Tiger12 team in appreciation of the incredible Gantry community."</p>
    ...
    <div class="g-grid">
        <div class="g-block size-50">
            <p>
                Helium was crafted with love by the <a href="http://tiger12.com">Tiger12</a> team to showcase the capabilities of the Gantry 5 framework. Helium is open source and available for free under a dual license system (<a href="http://www.opensource.org/licenses/mit-license.php">MIT</a> or <a href="http://www.gnu.org/licenses/old-licenses/gpl-2.0.html">GPL version 2 or later</a>). You do not have to keep the Gantry or Tiger12 links and logos in the front end, however, you must ensure that all copyright notices in the code are retained.
            </p>
        </div>
        <div class="g-block size-50">
            <p>
